...
<body>
  <div class="container-fluid">
    ...
    <h1><strong>Nuestros empleados</strong></h1>

    <div class="container">

      <div class="border border-2 border-success rounded bg-success-subtle">
        ...
        <div class="row cartas row-gap-3">
          ...
          <div class="card border-black" style="width: 18rem; ">
            ...
            <div class="card-body">
              ...
              <br><br>
              <a href="pedir cita.php" class="btn btn-primary">Pide cita</a>
            </div>
          </div>
