...
<body>
  <div class="container-fluid">
    ...
    <div class="flex-container border  bg-success-subtle border-dark border-3 rounded">
      <br>
      <div class="row"><br>
    ...
    <div>
      <form action="confirmar cita.php" method="post">
        ...
        <div class="container">
        <br><br>
          <div class="bg-light horario">
          <br>
          <div class="row g-1 align-content-center justify-content-center">
